...
ezra({ nomCom: "url", categorie: "General-Fredi", reaction: "👨🏿‍💻" }, async (origineMessage, zk, commandeOptions) => {
    ...
    try {
        ...
        switch (mediaType) {
            case 'image':
                repondre(`sir bravin url: ${catboxUrl}`);
                break;
            case 'video':
                repondre(`sir chege url: ${catboxUrl}`);
                break;
            case 'audio':
                repondre(`sir chege url: ${catboxUrl}`);
                break;
...
ezra({nomCom:"sticker",categorie: "sir chege-Conversion", reaction: "👨🏿‍💻"},async(origineMessage,zk,commandeOptions)=>{
...
ezra({nomCom:"photo",categorie: "sir chege-Conversion", reaction: "👨🏿‍💻"},async(dest,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
